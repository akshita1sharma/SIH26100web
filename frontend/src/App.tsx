  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="ml-64 p-8">
        ...
        {role === "bidder" && activePage === "Dashboard" ? (
          <BidderDashboard
            setActivePage={setActivePage}
          />
        ) : role === "bidder" && activePage === "MyTenders" ? (
          <MyTenders
            setActivePage={setActivePage}
          />
        ) : role === "bidder" && activePage === "MyBids" ? (
          <MyBids
            setActivePage={setActivePage}
          />
        ) : role === "bidder" && activePage === "UploadDocuments" ? (
          <UploadDocuments
            setActivePage={setActivePage}
          />
        ) : role === "bidder" && activePage === "VerificationStatus" ? (
          <VerificationStatus
            setActivePage={setActivePage}
          />
        ) : role === "officer" && activePage === "Tenders" ? (
          <Tenders
            tenders={tenders}
            setActivePage={setActivePage}
          />
        ) : role === "officer" && activePage === "Bidders" ? (
          <Bidders
            bidders={bidders}
            documents={documents}
          ...
          />
        ) : role === "officer" && activePage === "Documents" ? (
          <Documents
            documents={documents}
            verificationResults={verificationResults}
          />
        ) : role === "officer" && activePage === "Verification" ? (
          <Verification
            bidders={bidders}
            documents={documents}
            verificationResults={verificationResults}
